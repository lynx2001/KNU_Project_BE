    ...
    "나무": [{
        ...
        "output": {
            "summary_5sentences": (
                ...
                "최근 기업 이익 전망치도 빠르게 오르고 있습니다. 하지만 주가가 실적 개선 속도보다 너무 앞서간 것은 아닌지 밸류에이션 부담을 점검할 때입니다. "
                "단기적으로 거래대금이 급증하는 등 일부 과열 신호도 나타나고 있습니다. 이에 변동성 관리를 위해 분할 매도 등의 전략을 고려해볼 수 있습니다. "
    ...
    "숲": [{
        ...
        "output": {
            "summary_5sentences": (
                ...
                "이는 기간 프리미엄의 재평가로 이어질 수 있습니다. 결과적으로 수익률 곡선의 형태 또한 변화할 가능성이 커졌습니다. "
                "이에 기관 투자자들은 듀레이션 노출과 커브 포지셔닝을 더욱 세심하게 조정해야 합니다. "
                "만약 재정 건전성 우려가 커지면 외국인 자금 유출과 통화가치 하락이 동반될 수 있습니다. 따라서 정책 조합의 신뢰도를 해석하며 자산 비중을 조절하는 것이 중요합니다. "
            ),
            "key_points": [
